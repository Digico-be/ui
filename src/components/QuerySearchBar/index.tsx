    ...
    return (
        <div className={clsx('relative', className)}>
            <div className="absolute top-1/2 left-5 -translate-y-1/2">
                <svg className="size-6 fill-grey-800" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            ...
            {formData.watch('search') && (
                <button className="cursor-pointer absolute top-1/2 right-5 -translate-y-1/2 group" onClick={handleClear}>
                    <svg className="size-5 fill-grey-800 transition-all group-hover:fill-main" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
